...
<svg viewBox="0 0 400 240" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full">
	...
	<text x="12" y="108" font-size="10" font-weight="700" fill={color} opacity="0.85" text-anchor="start">O</text>
	<text x="12" y="140" font-size="10" font-weight="700" fill={color} opacity="0.7" text-anchor="start">R</text>
	<text x="12" y="172" font-size="10" font-weight="700" fill={color} opacity="0.55" text-anchor="start">A</text>
	...
	<!-- Main arrow -->
	<line x1="170" y1="72" x2="305" y2="72" stroke={color} stroke-width="1.5" marker-end="url(#dhcp-arrow)">
	...
	<line x1="310" y1="104" x2="85" y2="104" stroke={color} stroke-width="1.5" opacity="0.85" marker-end="url(#dhcp-arrow-back)">
		<animate attributeName="stroke-opacity" values="0.3;0.9;0.3" dur="4s" begin="0.5s" repeatCount="indefinite" />
	</line>
	...
	<!-- Offer details -->
	<text x="345" y="96" font-size="6" fill="#64748b" text-anchor="middle">
		lease: 24h
	</text>
	...
	<line x1="170" y1="136" x2="305" y2="136" stroke={color} stroke-width="1.5" opacity="0.7" marker-end="url(#dhcp-arrow)">
	...
	<!-- Step 4: ACK -->
	<line x1="310" y1="168" x2="85" y2="168" stroke={color} stroke-width="1.5" opacity="0.7" marker-end="url(#dhcp-arrow-back)">
		<animate attributeName="stroke-opacity" values="0.3;0.8;0.3" dur="4s" begin="1.5s" repeatCount="indefinite" />
	</line>
	...
	<rect x="28" y="182" width="85" height="28" rx="5" fill="#334155" stroke={color} stroke-width="1">
		<animate attributeName="stroke-opacity" values="0.3;1;0.3" dur="2s" begin="2s" repeatCount="indefinite" />
	</rect>
