...
<svg viewBox="0 0 400 240" class="w-full" xmlns="http://www.w3.org/2000/svg">
	<defs>
		<marker id="smtp-arrow" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
	...
	<rect
		...
		stroke-width="1"
	/>
	<text x="65" y="35" text-anchor="middle" fill="#e2e8f0" font-size="10" font-weight="600"
		>Mail Client</text
	>
	...
	<text x="132" y="94" text-anchor="middle" fill={color} font-size="8" opacity="0.8"
		>MAIL FROM:&lt;alice@a.com&gt;</text
	>
	...
	<text x="132" y="114" text-anchor="middle" fill={color} font-size="8" opacity="0.8"
		>RCPT TO:&lt;bob@b.com&gt;</text
	>
	...
	<text x="132" y="134" text-anchor="middle" fill={color} font-size="8" opacity="0.9"
