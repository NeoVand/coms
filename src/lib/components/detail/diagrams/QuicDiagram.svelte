...
<svg viewBox="0 0 400 240" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full">
	...
	<line
		...
		stroke="#64748b"
		stroke-width="1"
		marker-end="url(#quic-arrow-muted)"
	/>
	...
	<text x="305" y="73" font-size="8" fill="#94a3b8" text-anchor="middle"
		>Handshake + ServerHello</text
	>
	...
	<text x="305" y="210" font-size="8" fill={color} text-anchor="middle" opacity="0.8"> Fast </text>
</svg>
