...
<svg viewBox="0 0 400 240" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full">
	...
	<text x="160" y="37" font-size="8" fill="#94a3b8" text-anchor="middle"> GET /temperature </text>
	...
	<line
		...
		marker-end="url(#coap-arrow-back)"
	/>
	...
	<text x="356" y="72" font-size="6" fill={color} text-anchor="middle" font-weight="600"
		>~4 bytes</text
	>
	...
	<line
		...
		stroke-width="1"
		opacity="0.7"
		marker-end="url(#coap-arrow-notify)"
	>
		<animate
			attributeName="stroke-opacity"
			values="0.2;0.7;0.2"
