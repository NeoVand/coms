...
<div class="absolute left-3 top-3 z-[55] flex items-center gap-1 md:left-4 md:top-4 md:gap-1.5">
	...
	<div class="flex items-center gap-2.5 px-1">
		...
		<svg viewBox="0 0 20 20" class="h-5 w-5 shrink-0" fill="none">
			...
			<circle cx="16" cy="13.5" r="2" fill={isLight ? '#0284C7' : '#7dd3fc'} />
			<!-- Center hub -->
			<circle cx="10" cy="10" r="1.5" fill={isLight ? '#475569' : '#e2e8f0'} />
		</svg>
		<span class="text-sm font-semibold tracking-wide text-t-primary">Protocol Lab</span>
	</div>
