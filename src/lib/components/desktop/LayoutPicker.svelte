...
<div
	class="layout-picker absolute bottom-3 left-3 z-40 flex items-center gap-1.5 md:bottom-4 md:left-4 md:gap-2"
				...
				{#each layouts as layout (layout.id)}
					...
					>
						...
						{#if isActive}
							<svg
								viewBox="0 0 16 16"
								class="ml-auto h-3 w-3 shrink-0 text-t-primary"
								fill="currentColor"
							>
								<path
