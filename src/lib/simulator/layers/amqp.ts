		...
		headerFields: [
			{
				...
				editable: false,
				description: 'AMQP frame type — 1=Method, 2=Content Header, 3=Content Body, 8=Heartbeat'
			},
			{
				name: 'Channel',
				bits: 16,
				...
				editable: false,
				description: 'Channel number — 0 for connection-level, 1+ for application channels'
			},
			{
				name: 'Class.Method',
				bits: 0,
				...
				editable: false,
				description: 'AMQP class and method — Connection.Start, Channel.Open, Basic.Publish, etc.'
			},
			{
				name: 'Payload Size',
				bits: 32,
			...
			},
			{
				...
				editable: false,
				description: 'Message properties — content-type, delivery-mode, correlation-id, headers'
			},
			{
				name: 'Payload',
				bits: 0,
