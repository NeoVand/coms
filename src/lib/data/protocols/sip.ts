...
export const sip: Protocol = {
	...
	rfc: 'RFC 3261',
	oneLiner:
		'The "dialing" protocol for {{voip|VoIP}} — establishes, modifies, and tears down calls.',
...
account.create(acfg)  # Sends SIP REGISTER`,
		caption:
			'PJSIP registers with a [[sip|SIP]] server — the {{sip-invite|INVITE}}/200 OK/{{ack|ACK}} flow handles call setup',
		alternatives: [
			{
				language: 'javascript',
