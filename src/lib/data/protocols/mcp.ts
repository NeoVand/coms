...
# { "mcpServers": { "demo": { "command": "python", "args": ["server.py"] } } }`
	...
	image: {
		...
		caption:
			'The [[mcp|MCP]] architecture — a Host (AI application) creates Clients that connect 1:1 to Servers. Each Server exposes tools, resources, and prompts through a standard [[json-rpc|JSON-RPC]] interface. Created by Anthropic in 2024 and donated to the {{linux|Linux}} Foundation in 2025.',
