...
[[ntp|NTP]] uses a hierarchical system of time sources. Stratum 0 are atomic clocks and {{gps|GPS}} receivers. Stratum 1 servers {{mqtt-connect|connect}} directly to these. Stratum 2 servers sync from Stratum 1, and so on. Your computer typically syncs from Stratum 2 or 3 servers (like pool.ntp.org).
...
sudo ntpdate pool.ntp.org`
  ...
  Clock offset: +0.000022s`
	...
	image: {
		...
		caption:
			'The {{nist|NIST}}-F1 cesium fountain atomic clock — accurate to one second in 100 million years. Atomic clocks like this are the ultimate time source (Stratum 0) that [[ntp|NTP]] distributes to every device on the internet.',
