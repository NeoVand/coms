...
export const networkFoundationsProtocols: Protocol[] = [
	{
		...
		overview: `Ethernet is the {{protocol|protocol}} that makes local area networks work. Every time your computer talks to another device on the same network — a printer, a file server, a router — it wraps data in an Ethernet {{frame|frame}} with a source and destination {{mac-address|MAC address}}. The EtherType field tells the receiver what's inside: 0x0800 for [[ip|IP]], 0x0806 for [[arp|ARP]], 0x86DD for IPv6. It's the lingua franca of wired networking, operating at Layer 2 of the {{osi-model|OSI model}}.
