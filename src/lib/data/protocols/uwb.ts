...
Continuous Precision Finding refreshes at ~10 Hz on Apple silicon.`
	...
	recentChanges: [
		...
		},
		{
			...
			description:
				"On **26 February 2026** the CSA published **{{aliro|Aliro 1.0}}**, a PKI-based access-control credential standard with **[[nfc|NFC]] (tap) + BLE (proximity) + BLE+UWB (ranged, hands-free)** as its three transports. {{ecdsa|ECDSA}} mutual authentication; credentials provisioned into {{apple|Apple}}, {{google|Google}}, and Samsung wallets. First products: **Aqara U400** (first smart lock with UWB; {{aliro|Aliro}} coming via firmware update) and **Kwikset Halo {{imap-select|Select}} Plus**. Launch partners include {{apple|Apple}}, {{google|Google}}, Samsung, ASSA ABLOY, NXP, Infineon, STMicroelectronics, Silicon Labs, Nordic Semiconductor, plus smart-lock makers Schlage, Avia, Nuki, Xthings. {{aliro|Aliro}} generalises the {{apple|Apple}} Home Key UX across {{android|Android}} — the most consequential UWB-related deployment of 2026.",
			source: {
