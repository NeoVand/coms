...
Client → Server:
  SSH_MSG_CHANNEL_OPEN (90)
	...
	image: {
		...
		caption:
			'The [[ssh|SSH]] binary packet structure — every [[ssh|SSH]] message is wrapped in this format. The {{payload|payload}} is encrypted, random padding prevents traffic analysis, and the {{mac-address|MAC}} (Message Authentication Code) ensures integrity. This is what makes [[ssh|SSH]] secure where Telnet was not.',
