	...
	sections: [
		...
		},
		{
			...
			entries: [
				...
				{
					year: 1998,
					title: 'Gigabit Ethernet — 1 Gbps (fiber)',
					description:
						'1000BASE-X over fiber (802.3z, 1998); 1000BASE-T over twisted pair followed in 1999 (802.3ab). The era when Ethernet stopped being "the office LAN" and started being the data-center backbone.'
				},
				{
					year: 2003,
