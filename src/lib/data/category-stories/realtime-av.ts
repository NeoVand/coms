		...
		},
		{
			...
			people: [
				...
				},
				{
					...
					org: 'Google / IETF',
					contribution:
						'Led [[webrtc|WebRTC]] standardization across both the {{w3c|W3C}} and {{ietf|IETF}}. Former {{ietf|IETF}} Chair, bringing deep standards expertise to the effort.',
					imagePath:
